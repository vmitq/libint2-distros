...
fp37 = fp38 + src4[((hsi*15+9)*1+lsi)*1];
...
fp43 = fp44 + src4[((hsi*15+8)*1+lsi)*1];
...
fp49 = fp50 + src4[((hsi*15+7)*1+lsi)*1];
...
fp60 = -5.0000000000000000e-01 * src3[((hsi*15+6)*1+lsi)*1];
...
fp66 = fp67 + src4[((hsi*15+5)*1+lsi)*1];
...
fp72 = fp73 + src4[((hsi*15+4)*1+lsi)*1];
...
fp78 = 0.0000000000000000e+00 + src4[((hsi*15+3)*1+lsi)*1];
...
fp83 = -5.0000000000000000e-01 * src3[((hsi*15+3)*1+lsi)*1];
...
fp89 = fp90 + src4[((hsi*15+2)*1+lsi)*1];
...
fp95 = 0.0000000000000000e+00 + src4[((hsi*15+1)*1+lsi)*1];
...
fp100 = -5.0000000000000000e-01 * src3[((hsi*15+1)*1+lsi)*1];
...
fp106 = 0.0000000000000000e+00 + src4[((hsi*15+0)*1+lsi)*1];
...
fp110 = libint2::fma_plus(-5.0000000000000000e-01, src3[((hsi*15+0)*1+lsi)*1], 0.0000000000000000e+00);
