...
fp58 = fp59 + src6[((hsi*10+2)*1+lsi)*1];
...
fp64 = 0.0000000000000000e+00 + src6[((hsi*10+1)*1+lsi)*1];
...
fp69 = 5.0000000000000000e-01 * src5[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp71;
fp71 = 5.0000000000000000e-01 * src4[((hsi*10+1)*1+lsi)*1];
...
fp77 = 0.0000000000000000e+00 + src6[((hsi*10+0)*1+lsi)*1];
...
fp82 = 5.0000000000000000e-01 * src5[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp84;
LIBINT2_REALTYPE fp83;
fp83 = libint2::fma_plus(5.0000000000000000e-01, src4[((hsi*10+0)*1+lsi)*1], 0.0000000000000000e+00);
