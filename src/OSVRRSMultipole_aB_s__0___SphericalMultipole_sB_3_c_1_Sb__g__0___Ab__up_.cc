...
fp75 = libint2::fma_plus(5.0000000000000000e-01, src4[((hsi*10+0)*1+lsi)*1], 0.0000000000000000e+00);
...
fp84 = libint2::fma_plus(3.0000000000000000e+00, src1[((hsi*6+0)*1+lsi)*1], 0.0000000000000000e+00);
