...
fp54 = fp55 + src4[((hsi*10+2)*1+lsi)*1];
...
fp60 = 0.0000000000000000e+00 + src4[((hsi*10+1)*1+lsi)*1];
...
fp65 = 5.0000000000000000e-01 * src3[((hsi*10+1)*1+lsi)*1];
...
fp71 = 0.0000000000000000e+00 + src4[((hsi*10+0)*1+lsi)*1];
...
fp75 = libint2::fma_plus(5.0000000000000000e-01, src3[((hsi*10+0)*1+lsi)*1], 0.0000000000000000e+00);
