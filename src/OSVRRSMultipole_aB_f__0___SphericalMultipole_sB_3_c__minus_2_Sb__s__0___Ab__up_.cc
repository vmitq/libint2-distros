...
fp33 = libint2::fma_plus(-5.0000000000000000e-01, src3[((hsi*6+1)*1+lsi)*1], fp35);
...
fp44 = libint2::fma_plus(-5.0000000000000000e-01, src3[((hsi*6+0)*1+lsi)*1], 0.0000000000000000e+00);
