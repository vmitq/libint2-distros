...
fp10 = libint2::fma_plus(5.0000000000000000e-01, src4[((hsi*3+1)*1+lsi)*1], fp28);
...
fp15 = 0.0000000000000000e+00 + src5[((hsi*3+0)*1+lsi)*1];
...
fp19 = libint2::fma_plus(5.0000000000000000e-01, src4[((hsi*3+0)*1+lsi)*1], 0.0000000000000000e+00);
